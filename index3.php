...
$requete = "SELECT * from preinscription";
...
class PDF extends FPDF{
    ...
    public function EN_TETE(){
        ...
        $this->Cell(20);
        $this->Cell(25,4,utf8_encode("LISTE DES ETUDIANTS PREINSCRITS A L'UNIVERSITE MARIEN N'GOUABI"),0,'C',1);
    ...
    public function body(){
        ...
        $this->Cell(30,10,'NOM',1,0,'C',1);
        $this->Cell(30,10,'PRENOM',1,0,'C',1);
        $this->Cell(20,10,'GENRE',1,0,'C',1);
        $this->Cell(30,10,'DATE DE NAISSANCE',1,0,'C',1);
        $this->Cell(20,10,'PARCOURS',1,0,'C',1);
        $this->Cell(25,10,'ETABLISSEMENT',1,0,'C',1);
        $this->Cell(20,10,'NIVEAU',1,0,'C',1);
        $this->Ln();
        ...
        $this->Cell(30,10,$value['nom_etudiant'],1,0,'C',0);
        $this->Cell(30,10,$value['prenom_etudiant'],1,0,'C',0);
        $this->SetFont('Arial','B',7);
        $this->Cell(20,10,$value['genre'],1,0,'C',0);
        $this->SetFont('Arial','B',8);
        $this->Cell(30,10,$value['date_naissance'],1,0,'C',0);
        $this->SetFont('Arial','B',8);
        $this->Cell(20,10,$value['parcours'],1,0,'C',0);

        $this->SetFont('Arial','B',8);
        $this->Cell(25,10,$value['etablissement'],1,0,'C',0);

        $this->SetFont('Arial','B',8);
        $this->Cell(20,10,$value['niveau'],1,0,'C',0);
