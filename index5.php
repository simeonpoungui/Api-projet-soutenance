...
class PDF extends FPDF{
    ...
    public function EN_TETE(){
        ...
        $this->Cell(30);
        $this->Cell(25,4,utf8_encode("LISTE DE PAYEMENTS DE L'UNIVERSITE MARIEN N'GOUABI"),0,'C',1);
    ...
    public function body(){
        ...
        $this->Cell(30,10,'DOMAINE',1,0,'C',1);
        $this->Cell(20,10,'CYCLE',1,0,'C',1);
        $this->Cell(30,10,'NIVEAU',1,0,'C',1);
        $this->Cell(30,10,'MONTANT',1,0,'C',1);
        $this->Ln();
        ...
        $this->Cell(40,10,$value['nom'],1,0,'C',0);
        $this->Cell(30,10,$value['prenom'],1,0,'C',0);
        $this->SetFont('Arial','B',7);
        $this->Cell(30,10,$value['domaine'],1,0,'C',0);
        $this->SetFont('Arial','B',8);
        $this->Cell(20,10,$value['cycle'],1,0,'C',0);
        $this->SetFont('Arial','B',8);
        $this->Cell(30,10,$value['niveau'],1,0,'C',0);
        $this->SetFont('Arial','B',8);
        $this->Cell(30,10,$value['montant'],1,0,'C',0);
